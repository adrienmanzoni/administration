...
This package contains:
   ...
   Magnolia Core 5.6
   Magnolia Internationalization Framework 5.6
   Magnolia JAAS 5.6
   Magnolia Rendering 5.6
   Magnolia Templating 5.6
   Magnolia Templating for JSP 5.6
...
More information about this release can be found at:
    http://documentation.magnolia-cms.com/releases/5.6.html
